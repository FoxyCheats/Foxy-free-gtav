...
#define v3 Vector3
/*
* This is part of Foxy_engine All Credit's goes to Foxy & Vali Foxy Team 
* This base is made for educational intend only and may not use to destroy or abuse other player game's 
* We do not condone any type of cheating use it at your own risk
*/
