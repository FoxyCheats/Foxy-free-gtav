...
namespace ENTITY
{
	...
	static void CREATE_MODEL_SWAP(float x, float y, float z, float radius, Hash originalModel, Hash newModel, BOOL p6) { invoke<Void>(0x92C47782FDA8B2A3, x, y, z, radius, originalModel, newModel, p6); } // 0x92C47782FDA8B2A3 0x0BC12F9E crash protection 
...
namespace VEHICLE
{
	...
	static void SET_VEHICLE_CAN_SAVE_IN_GARAGE(Vehicle vehicle, BOOL p1) { invoke<Void>(0x428BACCDF5E26EAD, vehicle, p1); } // 0x428BACCDF5E26EAD 0x1604C2F5
...
namespace OBJECT
{
	...
	static void ENABLE_SAVING_IN_GARAGE(Hash hash, BOOL toggle) { invoke<Void>(0xF2E1A7133DD356A6, hash, toggle); } // 0xF2E1A7133DD356A6 0x43BB7E48
	...
	static Pickup CREATE_AMBIENT_PICKUP2(Hash pickupHash, float posX, float posY, float posZ, int p4, int value, Hash modelHash, BOOL returnHandle, BOOL p8) { return invoke<Pickup>(0x12AB0310C2281427, pickupHash, posX, posY, posZ, p4, value, modelHash, returnHandle, p8); } // 0x673966A0C0FD7171 0x17B99CE7
...
namespace GAMEPLAY
{
	...
	static void WATER_OVERRIDE_SET_STRENGHT(float strenght) { invoke<Void>(0xC54A08C85AE4D410, strenght); } // 0xC54A08C85AE4D410 0xDA02F415
	...
	static void _SET_SNOW_LEVEL(float level) { invoke<Void>(0x7F06937B0CDCBC1A, level); } // 0x7F06937B0CDCBC1A
	...
	static void _0xA74802FB8D0B7814(char* p0, float p1) { invoke<Void>(0xA74802FB8D0B7814, p0, p1); } // 0xA74802FB8D0B7814 0xC9FA6E07 0x7F06937B0CDCBC1A
...
namespace STREAMING
{
	...
	static BOOL IS_MODEL_A_PED(Hash model) { return invoke<BOOL>(0x75816577FEA6DAD5, model); } // 0x75816577FEA6DAD5 
	...
	static BOOL HAS_NAMED_PTFX_ASSET_LOADED1(char* fxName) { return invoke<BOOL>(0x8702416E512EC454, fxName); } // 0x8702416E512EC454 0x9ACC6446
...
namespace GRAPHICS
{
	...
	static void _SET_BLACKOUT2(BOOL enable) { invoke<Void>(0xE2B187C0939B3D32, enable); } // 0x1268615ACE24D504 0xAA2A0EAF
	...
	static void SET_PARTICLE_FX_NON_LOOPED_COLOUR(int r, int g, int b) { invoke<Void>(0x26143A59EF48B262, r, g, b); } // 0x26143A59EF48B262 0x7B689E20
...
namespace NETWORK
{
	...
	static int NETWORK_CREATE_SYNCHRONISED_SCENE(float x, float y, float z, float xRot, float yRot, float zRot, int p6, int p7, int p8, float p9, float p10, float p11) { return invoke<int>(0x7CD6BC4C2BBDD526, x, y, z, xRot, yRot, zRot, p6, p7, p8, p9); } // 0x7CD6BC4C2BBDD526 0xB06FE3FE
...
namespace NETWORKCASH
{
	...
	static void NETWORK_EARN_CASINO_AWARD(int amount, Hash hash) { invoke<Void>(0x973A9781A34F8DEB, amount, hash); } // 0x3DA5ECD1A56CBA6D 0x66DA9935
